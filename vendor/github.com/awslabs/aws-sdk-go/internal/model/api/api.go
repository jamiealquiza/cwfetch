...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/jamiealquiza/cloudwatch-graphite/vendor/github.com/awslabs/aws-sdk-go/aws": true,
	}
}
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/jamiealquiza/cloudwatch-graphite/vendor/github.com/awslabs/aws-sdk-go/internal/signer/v4"] = true
	a.imports["github.com/jamiealquiza/cloudwatch-graphite/vendor/github.com/awslabs/aws-sdk-go/internal/protocol/"+a.ProtocolPackage()] = true
